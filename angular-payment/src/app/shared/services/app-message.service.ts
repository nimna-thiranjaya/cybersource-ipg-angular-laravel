...
export class AppMessageService {
  ...
  private demShowAlert(type: ("success" | "info" | "warn" | "error"), summary: ("Success" | "Information" | "Warning" | "Error"), msg: string) {
    this.messageService.add({ severity: type, summary: summary, detail: msg  , life: 10000});
  }

  private showAlert(type: ("success" | "info" | "warn" | "error"), summary: ("Success" | "Information" | "Warning" | "Error"), msg: string) {
    this.messageService.add({ severity: type, summary: summary, detail: msg , life: 10000});
  }
}